...
ZIP-пакет для Jasefly Platform SDK. Провайдерный адаптер; в v1 — **OpenStreetMap + Leaflet**.

Публичный API компонента не привязан к поставщику: позже можно добавить Google / Яндекс / Mapbox без смены props.
