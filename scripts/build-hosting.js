...
function rootHtaccess() {
  return [
    ...
    '',
    '# Package FE assets: auth-aware gate (admin-only packs need staff cookie).',
    'RewriteRule ^modules/\\.access\\.json$ - [F,L]',
    'RewriteCond %{REQUEST_FILENAME} -f',
    'RewriteRule ^modules/(.+)$ /module-asset.php?f=$1 [L,QSA]',
    '',
