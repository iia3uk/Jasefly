...
final class TranslateService
{
    ...
    /**
     * Free Google Translate (gtx client) — neural MT, no API key.
    ...
    /** Map CMS lang codes to DeepL (uppercase; EN target → EN-GB). */
    ...
    /**
     * Split long strings so free MyMemory (≈500 chars) can handle them.
     *
     * @return list<string>
     */
