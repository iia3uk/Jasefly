...
final class YooKassaProvider extends AbstractProvider
{
    ...
    public function verifyWebhook(PlatformRequestInterface $r, array $settings): bool
    {
        ...
        $provided = (string) (($r->query()['token'] ?? null) ?? $r->header('X-Webhook-Token') ?? '');
...
final class StripeProvider extends AbstractProvider
{
    ...
    public function verifyWebhook(PlatformRequestInterface $r, array $settings): bool
    {
        ...
        return hash_equals(hash_hmac('sha256', $t . '.' . (string) json_encode($r->body(), JSON_UNESCAPED_UNICODE), $secret), $v1);
    }
...
final class CloudPaymentsProvider extends AbstractProvider
{
    ...
    public function verifyWebhook(PlatformRequestInterface $r, array $settings): bool
    {
        ...
        $expected = base64_encode(hash_hmac('sha256', (string) json_encode($r->body(), JSON_UNESCAPED_UNICODE), $secret, true));
