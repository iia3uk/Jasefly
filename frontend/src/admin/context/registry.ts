...
export const adminContext: Record<AdminContextKey, AdminContext> = {
  ...
  homepage: {
    title: 'Главная',
    what: 'Вёрстка главной в Page Builder (pages.layout_json).',
  ...
  'homepage-sections': {
    ...
    what: 'Заголовок, текст и CTA одной legacy-секции (синхронизация с виджетами).',
    where: 'Главная страница (/).',
    publicPath: '/',
  ...
  navigation: {
    title: 'Навигация',
    what: 'Билдер меню: шапка и подвал, порядок drag-and-drop, превью.',
  ...
  'social-links': {
    title: 'Соцсети',
    what: 'Ссылки на соцсети и профили (ядро CMS, не Portfolio).',
    where: 'Подвал всех страниц (если включён показ соцсетей).',
    publicPath: '/',
    previewKind: 'crudItem',
  },
  media: {
