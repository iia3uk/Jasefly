...
function Campaigns() {
  ...
  return <div className="space-y-4"><div className="flex justify-between"><div><h1 className="font-heading text-2xl">Рассылки</h1><p className="text-sm text-zinc-400">Кампании и отправка через планировщик.</p></div>
    <GhostButton onClick={() => { setSelected(null); setForm(blank) }}>Новая</GhostButton></div>
